...
public class ListTester {
	...
	private void runTests() {
		// TODO: you can name testListIter1Next2Prev
		// TODO: listiterator: test_adds test_sets test_prev
		// test cases with iterator change: testing outcome of iterator remove method
		// test with iterator change: testing if iterator works well for the list
		...
		testSingleElementList(emptyList_addAAtIndex0_A, "emptyList_addAatIndex0_A", LIST_A, STRING_A);
		testSingleElementList(emptyList_listIteraddA_A, "emptyList_listIteraddA_A", LIST_A, STRING_A); // #listiterator
																										// 62
		...
		testEmptyList(A_listIter1PrevRemove_empty, "A_listIter1PrevRemove_empty"); // #listiterator 56
		...
		testTwoElementList(A_addBAtIndex0_BA, "A_addBAtIndex0_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_listIterAddB_BA, "A_listIterAddB_BA", LIST_BA, STRING_BA); // #listiterator 63
		// 1-element to changed 1-element via set()
		testSingleElementList(A_setBAtIndex0_B, "A_setBAtIndex0_B", LIST_B, STRING_B);
		...
		testThreeElementList(AB_listIterAddC_CAB, "AB_listIterAddC_CAB", LIST_CAB, STRING_CAB); // #listiterator 66
		testThreeElementList(AB_listIterPrevAddC_CAB, "AB_listIterPrevAddC_CAB", LIST_CAB, STRING_CAB); // #listiterator
																										// 66
		testThreeElementList(AB_listIterNextAddC_ACB, "AB_listIterNextAddC_ACB", LIST_ACB, STRING_ACB); // #listiterator
																										// 66

		// 2-element to changed 2-element via set()
		testTwoElementList(AB_setCAtIndex0_CB, "AB_setCAtIndex0_CB", LIST_CB, STRING_CB);
		testTwoElementList(AB_setCAtIndex1_AC, "AB_setCAtIndex1_AC", LIST_AC, STRING_AC);
		testTwoElementList(AB_listIterSet0_CB, "AB_listIterSet0_CB", LIST_CB, STRING_CB);
		...
		testThreeElementList(ABC_listIterSet0_DBC, "ABC_listIterSet0_DBC", LIST_DBC, STRING_DBC); // #listiterator 77
		testThreeElementList(ABC_listIterSet1_ADC, "ABC_listIterSet1_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_listIterSet2_ABD, "ABC_listIterSet1_ADC", LIST_ABD, STRING_ABD);
	...
	/**
	 * Scenario: [A] -> iterRemove(A) -> empty list
	 * 
	 * @return empty list after iterRemove(A)
	 */
	...
	/**
	 * Scenario: [A] -> listIterRemove(A) -> empty list
	 * 
	 * @return empty list after listIterRemove(A)
	 */
	...
	/**
	 * Scenario: [A] -> listIter1PrevRemove() -> empty list
	 * 
	 * @return empty list after listIter1PrevRemove()
	 */
	private IndexedUnsortedList<Integer> A_listIter1PrevRemove_empty() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
	...
	private Scenario<Integer> A_listIter1PrevRemove_empty = () -> A_listIter1PrevRemove_empty();
	 ...
	 */
	private IndexedUnsortedList<Integer> emptyList_addAatIndex0_A() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(0, ELEMENT_A);
		return list;
	}

	private Scenario<Integer> emptyList_addAAtIndex0_A = () -> emptyList_addAatIndex0_A();

	/**
	 * Scenario: empty list -> listIterAdd(A) -> [A]
	 * 
	 * @return [A] after listIterAdd(A)
	 */
	private IndexedUnsortedList<Integer> emptyList_listIteraddA_A() {
		IndexedUnsortedList<Integer> list = newList();
		ListIterator<Integer> iterator = list.listIterator();
		iterator.add(ELEMENT_A);
		return list;
	}
	...
	/**
	 * Scenario: [A,B] -> listIterRemove(A) -> [B]
	 * 
	 * @return [B] after listIterRemove(A)
	 */
	 ...
	 * @return [C,A,B]
	 */
	private IndexedUnsortedList<Integer> AB_listIterPrevAddC_CAB() {
		IndexedUnsortedList<Integer> list = A_addBAfterA_AB();
	...
	private Scenario<Integer> AB_listIterPrevAddC_CAB = () -> AB_listIterPrevAddC_CAB();
	...
	private Scenario<Integer> AB_listIterNextAddC_ACB = () -> AB_listIterNextAddC_ACB();
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_setCAtIndex0_CB() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.add(ELEMENT_B);
	...
	private Scenario<Integer> AB_setCAtIndex0_CB = () -> AB_setCAtIndex0_CB();
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_setCAtIndex1_AC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.add(ELEMENT_B);
	...
	private Scenario<Integer> AB_setCAtIndex1_AC = () -> AB_setCAtIndex1_AC();
	 ...
	 * @return [C, B]
	 */
	private IndexedUnsortedList<Integer> AB_listIterSet0_CB() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		ListIterator<Integer> iterator = list.listIterator(1);
		iterator.previous();
		iterator.set(ELEMENT_C);
		return list;
	}

	private Scenario<Integer> AB_listIterSet0_CB = () -> AB_listIterSet0_CB();
	 ...
	 */
	private IndexedUnsortedList<Integer> A_setBAtIndex0_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.set(0, ELEMENT_B);
		return list;
	}

	private Scenario<Integer> A_setBAtIndex0_B = () -> A_setBAtIndex0_B();
	...
	/**
	 * Scenario: [A] -> add(B) -> [B,A]
	 * 
	 * @return [B,A] after add(B)
	 */
	private IndexedUnsortedList<Integer> A_addBAtIndex0_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.add(0, ELEMENT_B);
		return list;
	}

	private Scenario<Integer> A_addBAtIndex0_BA = () -> A_addBAtIndex0_BA();

	/**
	 * Scenario: [A] -> listIterAdd(B) -> [B, A]
	 * 
	 * @return [B, A] after listIterAdd(B)
	 */
	private IndexedUnsortedList<Integer> A_listIterAddB_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> iterator = list.listIterator();
		iterator.add(ELEMENT_B);
		return list;
	}
	...
	private IndexedUnsortedList<Integer> ABC_remove1_AC() {
		IndexedUnsortedList<Integer> list = ABC_set0_DBC();
	...
	/**
	 * Scenario: [A,B,C] -> iterRemove(A) -> [B,C]
	 * 
	 * @return [B,C] after iterRemove(A)
	 */
	...
	/**
	 * Scenario: [A,B,C] -> listIterRemove(A) -> [B,C]
	 * 
	 * @return [B,C] after listIterRemove(A)
	 */
	...
	/**
	 * Scenario: [A,B,C] -> iterRemove(B) -> [A,C]
	 * 
	 * @return [A,C] after iterRemove(B)
	 */
	...
	/**
	 * Scenario: [A,B,C] -> listIterRemove(B) -> [A,C]
	 * 
	 * @return [A,C] after listIterRemove(B)
	 */
	 ...
	 * @return [D,B,C]
	 */
	private IndexedUnsortedList<Integer> ABC_listIterSet0_DBC() {
		IndexedUnsortedList<Integer> list = AB_addCAfterB_ABC();
		ListIterator<Integer> iterator = list.listIterator();
		iterator.next();
	...
	private Scenario<Integer> ABC_listIterSet0_DBC = () -> ABC_listIterSet0_DBC();
	 ...
	 * @return [A,D,C]
	 */
	private IndexedUnsortedList<Integer> ABC_listIterSet1_ADC() {
		IndexedUnsortedList<Integer> list = AB_addCAfterB_ABC();
	...
	private Scenario<Integer> ABC_listIterSet1_ADC = () -> ABC_listIterSet1_ADC();
	 ...
	 * @return [A,B,D]
	 */
	private IndexedUnsortedList<Integer> ABC_listIterSet2_ABD() {
		IndexedUnsortedList<Integer> list = AB_addCAfterB_ABC();
		ListIterator<Integer> iterator = list.listIterator(3);
		iterator.previous();
		iterator.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_listIterSet2_ABD = () -> ABC_listIterSet2_ABD();
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents,
		...
		try {
			...
			printTest(scenarioName + "_testIterNext",
					testIterNext(scenario.build().iterator(), contents[0], Result.MatchingValue));
			// an iterator after one call to the next() method
			printTest(scenarioName + "_iterNext_testIterRemove",
					testIterRemove(iterAfterNext(scenario.build(), 1), Result.NoException));
			printTest(scenarioName + "_iterNext_testIterHasNext",
			...
			// an iterator after one call to next() immediately followed by a call to
			// remove()
			printTest(scenarioName + "_iterNextRemove_testIterRemove",
					testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1)), Result.IllegalState));
			printTest(scenarioName + "_iterNextRemove_testIterHasNext",
			...
			// an iterator after two consecutive calls to next() immediately followed by a
			// call to remove()
			...
			// an iterator after one call to next(), a call to remove(), and finally,
			// another call to next()
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove",
					testIterRemove(iterAfterNext(iterAfterRemove(iterAfterNext(scenario.build(), 1)), 1),
							Result.NoException));
			printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext",
					testIterHasNext(iterAfterNext(iterAfterRemove(iterAfterNext(scenario.build(), 1)), 1),
							Result.False));
			printTest(scenarioName + "_iterNextRemoveNext_testIterNext",
					testIterNext(iterAfterNext(iterAfterRemove(iterAfterNext(scenario.build(), 1)), 1), null,
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				// added the following:
				printTest(scenarioName + "_testListIterNextNextRemove",
						testIterRemove(listIterAfterNext(scenario.build().listIterator(), 2), Result.NoException));
				printTest(scenarioName + "_testListIterNextNextAdd", testListIterAdd(
						listIterAfterNext(scenario.build().listIterator(), 2), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextSet", testListIterSet(
						listIterAfterNext(scenario.build().listIterator(), 2), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextRemoveRemove",
						testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)),
								Result.IllegalState));
				printTest(scenarioName + "_testListIterNextNextPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 1),
								Result.NoException));
				printTest(scenarioName + "_testListIterNextNextPreviousRemoveRemove", testIterRemove(
						listIterAfterRemove(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 1)),
						Result.IllegalState));
				printTest(scenarioName + "_testListIterNextNextPreviousAdd",
						testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextPreviousSet",
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents,
		...
		try {
			...
			printTest(scenarioName + "_iterNextNextRemove_testIterNext",
					testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), contents[2],
							Result.MatchingValue));
			// an iterator after two calls to next(), a call to remove(), and finally
			// another call to next()
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterRemove",
					testIterRemove(iterAfterNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), 1),
							Result.NoException));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterHasNext",
					testIterHasNext(iterAfterNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), 1),
							Result.False));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterNext",
					testIterNext(iterAfterNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), 1), null,
							Result.NoSuchElement));
			...
			printTest(scenarioName + "_iterNextNextNext_testIterNext",
					testIterNext(iterAfterNext(scenario.build(), 3), null,
							Result.NoSuchElement));
			// an iterator after three consecutive calls to next() followed by a call to
			// remove()
			...
			printTest(scenarioName + "_iterNextNextNextRemove_testIterNext",
					testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 3)), null,
							Result.NoSuchElement));
			// ListIterator
			if (SUPPORTS_LIST_ITERATOR) { // TODO: nextnextnext, nextprev, nextnextprev, nextnextnextprev, //
											// nextnextnext to test boundaries
				printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.NoException));
				printTest(scenarioName + "_testListIterNeg1",
						testListIter(scenario.build(), -1, Result.IndexOutOfBounds));
				printTest(scenarioName + "_testListIter0", testListIter(scenario.build(), 0, Result.NoException));
				...
				// added the following:
				printTest(scenarioName + "_testListIterNextNextNextRemove",
						testIterRemove(listIterAfterNext(scenario.build().listIterator(), 3), Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextAdd", testListIterAdd(
						listIterAfterNext(scenario.build().listIterator(), 3), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextSet", testListIterSet(
						listIterAfterNext(scenario.build().listIterator(), 3), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextRemoveRemove",
						testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 3)),
								Result.IllegalState));
				printTest(scenarioName + "_testListIterNextNextNextPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 1),
								Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousRemoveRemove", testIterRemove(
						listIterAfterRemove(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 1)),
						Result.IllegalState));
				printTest(scenarioName + "_testListIterNextNextNextPreviousAdd",
						testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousSet",
	 ...
	 * @return Iterator for given list, after numCallsToNext
	 */
	private Iterator<Integer> iterAfterNext(Iterator<Integer> it, int numCallsToNext) {
		for (int i = 0; i < numCallsToNext; i++) {
			it.next();
		}
		return it;
